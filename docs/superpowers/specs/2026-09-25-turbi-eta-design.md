...
- **Mezcla con el plan:** ETA = w × radar + (1 − w) × plan.
  ...
  - Se reduce según la antigüedad de la señal (`seenS`): ×1 hasta 15 s, ×0,8 hasta 60 s, ×0,6 hasta 120 s y ×0,4 por encima. A menos de 100 km del destino, el factor se eleva al cuadrado.
...
**Todos los valores anteriores son heurísticas razonables, no valores demostrados**: 800 km/h, 150 km y 23 min, ×1,05, pesos del 40/70/90 %, factores de antigüedad, 12/60 min, suavizado y redondeo.
