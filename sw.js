...
const CACHE = 'turbi-v52';
const SHELL = [
  './', 'index.html', 'css/style.css?v=2026-09-25.2', 'manifest.json',
  'js/app.js?v=2026-09-25.2', 'js/ui.js', 'js/route.js', 'js/time.js', 'js/weather.js', 'js/turbulence.js',
