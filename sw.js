...
const CACHE = 'turbi-v53';
const SHELL = [
  './', 'index.html', 'css/style.css?v=2026-09-26.1', 'manifest.json',
  'js/app.js?v=2026-09-26.1', 'js/ui.js', 'js/route.js', 'js/time.js', 'js/weather.js', 'js/turbulence.js',
