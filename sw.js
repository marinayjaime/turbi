...
const CACHE = 'turbi-v69';
const SHELL = [
  './', 'index.html', 'css/style.css?v=2026-09-26.17', 'manifest.json',
  'js/app.js?v=2026-09-26.17', 'js/ui.js', 'js/route.js', 'js/time.js', 'js/weather.js', 'js/turbulence.js',
