...
const CACHE = 'turbi-v59';
const SHELL = [
  './', 'index.html', 'css/style.css?v=2026-09-26.7', 'manifest.json',
  'js/app.js?v=2026-09-26.7', 'js/ui.js', 'js/route.js', 'js/time.js', 'js/weather.js', 'js/turbulence.js',
