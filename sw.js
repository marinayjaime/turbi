...
const CACHE = 'turbi-v54';
const SHELL = [
  './', 'index.html', 'css/style.css?v=2026-09-26.2', 'manifest.json',
  'js/app.js?v=2026-09-26.2', 'js/ui.js', 'js/route.js', 'js/time.js', 'js/weather.js', 'js/turbulence.js',
