...
const CACHE = 'turbi-v57';
const SHELL = [
  './', 'index.html', 'css/style.css?v=2026-09-26.5', 'manifest.json',
  'js/app.js?v=2026-09-26.5', 'js/ui.js', 'js/route.js', 'js/time.js', 'js/weather.js', 'js/turbulence.js',
  'js/flight.js', 'js/airports.js', 'js/places.js', 'js/schedule.js', 'js/radar.js', 'js/radar-gate.js', 'js/radar-distance.js', 'js/eta.js', 'js/airline-photos.js',
