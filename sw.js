...
const CACHE = 'turbi-v62';
const SHELL = [
  './', 'index.html', 'css/style.css?v=2026-09-26.10', 'manifest.json',
  'js/app.js?v=2026-09-26.10', 'js/ui.js', 'js/route.js', 'js/time.js', 'js/weather.js', 'js/turbulence.js',
