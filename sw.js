...
const CACHE = 'turbi-v68';
const SHELL = [
  './', 'index.html', 'css/style.css?v=2026-09-26.16', 'manifest.json',
  'js/app.js?v=2026-09-26.16', 'js/ui.js', 'js/route.js', 'js/time.js', 'js/weather.js', 'js/turbulence.js',
  'js/flight.js', 'js/aliases.js', 'js/adb.js', 'js/airports.js', 'js/places.js', 'js/schedule.js', 'js/radar.js', 'js/radar-gate.js', 'js/radar-distance.js', 'js/physical-flight.js', 'js/status-refresh.js', 'js/eta.js', 'js/airline-photos.js',
